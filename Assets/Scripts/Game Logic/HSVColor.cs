...
public struct HSVColor {
    ...
    public static implicit operator Color(HSVColor hsvColor) {
        return ToColor(hsvColor);
    }

    public static Vector3 To3dSpace(HSVColor hsvColor) {
        Vector3 pos = new Vector3(
            Mathf.Cos(hsvColor.h) * hsvColor.s * hsvColor.v,
            Mathf.Sin(hsvColor.h) * hsvColor.s * hsvColor.v,
            hsvColor.v
            );
        return pos;
    }

    public Vector3 To3dSpace() {
        return To3dSpace(this);
    }

    public static implicit operator Vector3(HSVColor color) {
        return To3dSpace(color);
    }
